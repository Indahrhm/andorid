package com.privilage.laundry.view.dryclean;
...
public class DryCleanActivity extends AppCompatActivity {
    ...
    private void setInitLayout() {
        ...
        tvInfo.setText("Cuci dalam merupakan layanan cuci sepatu bagian dalam saja");
    }
    ...
    private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItems == 0 || totalPrice == 0) {
                ...
                Toast.makeText(DryCleanActivity.this, "Pesanan Anda sedang diproses, harap lakukan pembayaran", Toast.LENGTH_SHORT).show();
                finish();
            }
            Intent intent = new Intent(DryCleanActivity.this, Payment.class);
