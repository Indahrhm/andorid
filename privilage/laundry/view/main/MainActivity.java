...
import com.privilage.laundry.view.dryclean.DryCleanActivity;
import com.privilage.laundry.view.history.HistoryActivity;
import com.privilage.laundry.view.premiumwash.PremiumWashActivity;
import com.privilage.laundry.viewmodel.MainViewModel;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void setInitLayout() {
        ...
        imageButton = findViewById(R.id.btnAkun);
    ...
    private void setMenu() {
        modelMenu = new ModelMenu("Cuci Dalam", R.drawable.image);
        modelMenuList.add(modelMenu);
        modelMenu = new ModelMenu("Cuci Luar", R.drawable.image);
        modelMenuList.add(modelMenu);
        modelMenu = new ModelMenu("Premium Wash", R.drawable.image);
        modelMenuList.add(modelMenu);
