package com.privilage.laundry.view.premiumwash;
...
import com.privilage.laundry.view.cucibasah.CuciBasahActivity;
...
public class PremiumWashActivity extends AppCompatActivity {
    ...
    int hargaCassual = 30000, hargaFlat = 20000, hargaKids = 20000, hargaSneakers = 30000, hargaSlipper = 15000;
    ...
    private void setInitLayout() {
        ...
        addDataViewModel = new ViewModelProvider(this, (ViewModelProvider.Factory) ViewModelProvider
        ...
        tvInfo.setText("Premium Wash menawarkan cuci Sepatu Luar dan Dalam ");
    }
    ...
    private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItems == 0 || totalPrice == 0) {
                ...
                Toast.makeText(PremiumWashActivity.this, "Pesanan Anda sedang diproses, harap lakukan pembayaran", Toast.LENGTH_SHORT).show();
                finish();
            }
            Intent intent = new Intent(PremiumWashActivity.this, Payment.class);
